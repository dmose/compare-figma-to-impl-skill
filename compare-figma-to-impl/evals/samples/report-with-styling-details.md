...
| Title font-family | system-ui | -apple-system, BlinkMacSystemFont | Yes (system) |
| Icon opacity | 1.0 | 1.0 | Yes |
| Close btn background | transparent | transparent | Yes |
| Close btn hover bg | rgba(0,0,0,0.1) | rgba(0,0,0,0.1) | Yes |
