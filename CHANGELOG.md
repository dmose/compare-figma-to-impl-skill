...
### Changed
- Internal: Expand INSTALL-TESTING.md with detailed Parallels VM setup
  steps for Firefox build and Claude Code install; no user-facing changes.

## [0.1.10] - 2026-05-18

### Changed
- Internal: TODO tracker reorganization; no user-facing changes.
...
[Unreleased]: https://github.com/dmose/compare-figma-to-impl/compare/v0.1.10...HEAD
[0.1.10]: https://github.com/dmose/compare-figma-to-impl/compare/v0.1.9...v0.1.10
